...
const projects = [{
  ...
  content:'<p>GPS was designed to determine locations accurately for humans to have more control, up till now, people have been using GPS for monitoring and surveilling, but what if we handed this technology over to the ocean?<br><br>In this project, we put a GPS tracker and a note into a plastic bottle and threw it into the Spree River, thereby we capture the streams and make them visible. We ask people who pick up the bottle to take a picture of where they were and send it to an anonymous e-mail address.</p>',
}]
